...
export function Hero() {
  ...
  const certLogos = [
    ...
    },
    {
      name: "HubSpot",
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="#FF7A59" aria-hidden="true">
          <path d="M22.175 14.278a5.197 5.197 0 0 1-4.3 2.264 5.19 5.19 0 0 1-5.18-5.18 5.19 5.19 0 0 1 5.18-5.18c1.274 0 2.44.464 3.34 1.225V4.39a7.617 7.617 0 0 0-3.34-.77A7.618 7.618 0 0 0 9.698 11.2c0 2.085.84 3.974 2.203 5.352A7.575 7.575 0 0 0 17.475 19a7.608 7.608 0 0 0 6.525-3.685l-1.825-1.037zM6.545 8.23V6.31H4.9V4.67H3.13V6.31H1.49V8.23H3.13v4.78c0 1.994 1.27 3.036 3.413 2.758v-1.85c-.832.065-1.668-.234-1.668-1.217V8.23h1.67z"/>
        </svg>
      ),
    },
    {
      name: "Clutch.co",
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="#EF4335" aria-hidden="true">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-[1fr_1.1fr] gap-10 xl:gap-16 items-center">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            {/* H1 */}
            <FadeIn delay={0.1}>
              <h1 className="text-[2rem] sm:text-[2.6rem] lg:text-[2.9rem] xl:text-[3.5rem] font-black text-slate-900 leading-[1.12] tracking-tight mb-5">
            ...
            {/* Subheadline */}
            <FadeIn delay={0.2}>
              <p className="text-base sm:text-lg text-slate-500 leading-relaxed mb-7 max-w-lg mx-auto lg:mx-0">
            ...
            {/* CTA row */}
            <FadeIn delay={0.3}>
              <div className="flex flex-col sm:flex-row gap-3 mb-7 w-full sm:w-auto">
                <Link
                  href="/free-audit"
            ...
            <FadeIn delay={0.5}>
              <div className="w-full">
                <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest mb-3 text-center lg:text-left">
                  Certified by
                </p>
                <div className="flex items-stretch divide-x divide-slate-200 border border-slate-200 rounded-xl overflow-hidden bg-white shadow-sm w-full max-w-xs lg:max-w-none">
                  {certLogos.map(({ name, icon }) => (
                    <div
                      key={name}
                      className="flex flex-col items-center justify-center gap-1.5 flex-1 py-3 px-2 bg-white hover:bg-slate-50 transition-colors duration-150"
                    >
                      {icon}
                      <span className="text-[10px] font-semibold text-slate-500 leading-tight text-center whitespace-nowrap">
                        {name}
                      </span>
                    </div>
                  ))}
